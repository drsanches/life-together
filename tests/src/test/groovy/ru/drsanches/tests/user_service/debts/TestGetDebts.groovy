...
class TestGetDebts extends Specification {
    ...
    def "success debts getting"() {
        ...
        def money = 100
        RequestUtils.sendMoney(username1, password1, [userId1, userId2, userId3] as List<String>, money * 3)
        RequestUtils.sendMoney(username2, password2, [userId1, userId2] as List<String>, money * 2)
        RequestUtils.sendMoney(username3, password3, [userId1] as List<String>, money * 2)
    ...
    def "get debts with removed friend"() {
        ...
        RequestUtils.sendMoney(username1, password1, [userId2] as List<String>, money)
